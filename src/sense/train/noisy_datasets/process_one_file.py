...
def process_audio_file(args):
    ...
    wav_file, noise_list, snr_range, target_path = args
    ...
    try:
        ...
        # Save noisy audio
        sf.write(target_path, noisy_audio, sr)
...
def main():
    ...
    process_args = (input_file, noise_list, snr_range, output_file)

    process_audio_file(process_args)
