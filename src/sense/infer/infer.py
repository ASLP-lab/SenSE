...
def main():
    ...
    ref_audio_mel_fm = wav_to_fm_mel(ref_audio_wav_fm.unsqueeze(0)).permute(0, 2, 1)
    noisy_audio_mel_fm = wav_to_fm_mel(noisy_audio_wav_fm.unsqueeze(0)).permute(0, 2, 1)
