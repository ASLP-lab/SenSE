...
class ComputeScore:
    ...
    def __call__(self, fpath, sampling_rate):
        ...
        for idx in range(num_hops):
            ...
            mos_ovr_raw = self.onnx_sess.run(None, oi)[0][0][2]  # The 3rd output is OVRL
            _, _, mos_ovr = self.get_polyfit_val(0, 0, mos_ovr_raw)  # Only keep mos_ovr
...
if __name__=="__main__":
    ...
    parser.add_argument('-d', "--dnsmos_path", default='src/sense/eval/dnsmos/DNSMOS', help='Path to the DNSMOS model directory')
